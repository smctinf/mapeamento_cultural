...
urlpatterns = [
    ...
    path('acc/meus_cadastros/detalhes/01<id>1561', views.cadastro_map_cultural_cpf, name='acc_meus_cadastros_map'),
    path('acc/meus_cadastros/detalhes/01<id>4894/editar/b', views.editar_artista_b, name='acc_editar_map_b'),
    path('acc/meus_cadastros/detalhes/01<id>4894/editar/c', views.editar_artista_c, name='acc_editar_map_c'),
    path('acc/meus_cadastros/detalhes/01<id>4894/editar/cmp', views.editar_etapa_2, name='acc_editar_map_cmp'),    
    ...
    path('mapeamento-cultural/cadastrar/etapa-3/<id>/<tipo>', views.cadastro_etapa_3, name='cad_cult_etapa3'),
    path('mapeamento-cultural/cadastrar/anexos/<id>/<tipo>', views.cadastro_anexo, name='cad_cult_anexo'),
