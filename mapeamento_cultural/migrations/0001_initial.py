# Generated by Django 3.2.13 on 2022-08-19 16:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone', models.CharField(max_length=15, validators=[mapeamento_cultural.validations.validate_TELEFONE])),
                ...
                ('cnpj', models.CharField(max_length=18, null=True, unique=True, validators=[mapeamento_cultural.validations.validate_CNPJ], verbose_name='CNPJ')),
                ...
                ('area', models.ManyToManyField(blank=True, null=True, to='mapeamento_cultural.Area_Atuacao', verbose_name='Área(s) de atuação')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comprovante', models.FileField(blank=True, null=True, upload_to='file_comprovante_recibos', verbose_name='Recibos, contratos ou notas que comprovem cachê')),
                ('artista', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mapeamento_cultural.artista', verbose_name='Artista')),
            ],
        ),
        migrations.CreateModel(
            name='Log_anexos',
            fields=[
                ...
                ('artista', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mapeamento_cultural.artista', verbose_name='Artista')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qnt', models.CharField(blank=True, choices=[('0', '0 a 10'), ('1', '11 a 20'), ('2', '21 a 30'), ('3', '31 a 40'), ('4', '41 a 50'), ('5', 'Mais de 50')], max_length=1, null=True, verbose_name='Quantidade de pessoas que fazem parte da instituição')),
